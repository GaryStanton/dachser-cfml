/**
 * Name: Dachser Shipment History API
 * Author: Gary Stanton (@SimianE)
 * Description: Wrapper for the Dachser Shipment History API.
 */
component singleton accessors="true" extends="dachser" {
	 ...
	 * @apikey  Your API key
	 */
	private shipmentHistory function init(
			string apikey
	){  
	...
	public function retrieve(
		...
		return makeRequest(
			endpointString 	= 'shipmenthistory'
		,	method 			= 'GET'
		,	params 			= Local.params
		)
	}
